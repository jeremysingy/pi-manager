...
<xsl:stylesheet id="projectDescription" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="project">
    ...
    <h3>
      Nombre d'étudiants: <xsl:value-of select="nbStudent/text()" />
    </h3>
    <div>
  ...
  <!-- Template that manage the creation of the technogies -->
  <xsl:template match="technologies" name="technologies">
    <h3>Technologies:</h3>
    <ul>
  ...
  <!-- Template that write the name of one technology -->
  <xsl:template match="technology" name="technology">
    <li>
